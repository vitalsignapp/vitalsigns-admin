  ...
  $.fn.datetimepicker = function(opt, opt2) {
    ...
    createDateTimePicker = function(input) {
          ...
          input.off("blur.xdsoft").on("blur.xdsoft", function() {
            if (
              ...
              if (
                ...
                $(this).val(
                  dateHelper.formatDate(_xdsoft_datetime.now(), options.format)
                );
              }
      ...
      setPos = function() {
        ...
        if (
          document.documentElement.clientWidth - offset.left <
          datepicker.parent().outerWidth(true)
        ) {
          var diff =
            datepicker.parent().outerWidth(true) -
            datetimepickerelement.offsetWidth;
          left = left - diff;
        }
        /**
         * by Soon end
        ...
        if (options.fixed) {
          ...
          if (
            top + datetimepickerelement.offsetHeight >
        ...
        do {
          ...
          if (
            window.getComputedStyle(node).getPropertyValue("position") ===
              "relative" &&
